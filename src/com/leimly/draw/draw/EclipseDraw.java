...
import com.leimly.draw.shape.EclipseShape;
 ...
 */
public class EclipseDraw extends Draw {
    @Override
    public Group creatDraw(Group group, Pen p, AnchorPane drawAnchorPane) {
        PenShape penShapeEclipse = new EclipseShape();
        javafx.scene.shape.Shape shape = penShapeEclipse.setDraw(p);
